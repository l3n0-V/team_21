...
export default function DailyChallengesScreen({ route }) {
  ...
  useEffect(() => {
    if (route?.params?.challenge) {
      navigation.replace("DailyPractice", { challenge: route.params.challenge });
    }
  ...
  return (
    <SafeAreaView style={[styles.safeArea, { backgroundColor: colors.backgroundSecondary }]}>
      <View style={[styles.container, { backgroundColor: colors.backgroundSecondary }]}>
        ...
        {/* Screen Title */}
        <Text style={[styles.screenTitle, { color: colors.primary }]}>Daglige utfordringer</Text>
